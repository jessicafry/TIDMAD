...
parser.add_argument('-n', '--num_workers', type=int,  help='maximum number of workers for parallel processing, default: 32', default=8)
parser.add_argument('--delete_files', action='store_true',help='Delete all validation files after running this script')
